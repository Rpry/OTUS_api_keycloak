...
1. Предварительные действия:
  а. Убедиться, что у вас установлена БД постгрес, если нет - раскоментитровать в application.yml блок постгреса и его волюм ниже
  b. Убедиться что есть БД keycloak, если нет - создать (create database keycloak)
  c. Стянуть проект UI https://github.com/Rpry/OTUS_UI_keycloak (в любое место) 
